...
from NODECSaf import *
from datetime import datetime

import timeit
class ExperimentsNDECSaf:
    def __init__(self, dataset_path, datasets, detection_algos, budget_percentages, sampleInternalPercentage,
        ...
        self.rounds = rounds
        self.nodec = NODEC(dataset_path=self.dataset_path)
        exp_file_name = self.dataset_path +"results/nodec/"+ "nodec_"+datetime.today().strftime('%Y-%m-%d-%H:%M:%S') + ".experiments"
...
def main():
    ...
    datasets = ["terrorist1"]  # "terrorist2","terrorist1","blogcatalog" #"pubmed","webkb", "cora", "citeseer","facebook","netscience"
